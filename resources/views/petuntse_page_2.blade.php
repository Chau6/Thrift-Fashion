					...
					<div id="content" class="col-sm-9">
												...
												<ul>
													<li>
														<div class="subcategory-image">
															<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/category&amp;path=20_26">
													...
													<li>
														<div class="subcategory-image">
															<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/category&amp;path=20_92">
																<img src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/banners/category-image-129x40.jpg" alt="" />
															</a>
														</div>
							...
							<div class="row">
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"quaerat+outt+voluptatem"])}}">
												<img
													class="image_thumb"
										...
										<div class="thumb-description">
											<div class="caption">
												<div class="product-description">
													<h4><a href="{{route('client.shopping_cart.details',['id'=>"quaerat+outt+voluptatem"])}}">quaerat outt voluptatem</a></h4>
												...
												<div class="product-price-and-shipping">
													<div class="price">$1,000.00 <span class="price-tax">Ex Tax: $1,000.00</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart" type="button" title="Add to Cart" onclick="cart.add('44')">
															<i class="material-icons">add</i><span class="hidden-xs hidden-sm hidden-md"><a href="{{route('client.shopping_cart.details',['id'=>"quaerat+outt+voluptatem"])}}">Add to Cart</a> </span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('44');">
														...
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=44')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
								...
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"similique+suntin+culpaqui"])}}">
												<img
													class="image_thumb"
										...
										<div class="thumb-description">
											<div class="caption">
												<div class="product-description">
													<h4><a href="{{route('client.shopping_cart.details',['id'=>"similique+suntin+culpaqui"])}}">similique suntin culpaqui</a></h4>
													<p class="description">Redefine your workday with the Palm Treo Pro smartphone. Perfectly balanced, you can respond to busi..</p>
												</div>
												<div class="product-price-and-shipping">
													<div class="price">$279.99 <span class="price-tax">Ex Tax: $279.99</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart" type="button" title="Add to Cart" onclick="cart.add('29')">
															<i class="material-icons">add</i><span class="hidden-xs hidden-sm hidden-md"><a href="{{route('client.shopping_cart.details',['id'=>"similique+suntin+culpaqui"])}}">Add to Cart</a> </span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														...
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=29')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
								...
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"sint+incidunt+utlabore"])}}">
												<img
													class="image_thumb"
										...
										<div class="thumb-description">
											<div class="caption">
												<div class="product-description">
													<h4><a href="{{route('client.shopping_cart.details',['id'=>"sint+incidunt+utlabore"])}}">sint incidunt utlabore</a></h4>
													<p class="description">Product 8..</p>
												</div>
												<div class="product-price-and-shipping">
													<div class="price">$100.00 <span class="price-tax">Ex Tax: $100.00</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart" type="button" title="Add to Cart" onclick="cart.add('35')">
															<i class="material-icons">add</i><span class="hidden-xs hidden-sm hidden-md"><a href="{{route('client.shopping_cart.details',['id'=>"sint+incidunt+utlabore"])}}">Add to Cart</a> </span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														...
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=35')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
								...
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"tempora+incidunt+utlabore"])}}">
												<img
													class="image_thumb"
										...
										<div class="thumb-description">
											<div class="caption">
												...
												<div class="product-price-and-shipping">
													<div class="price"><span class="price-new">$20.00</span> <span class="price-old">$200.00</span> <span class="price-tax">Ex Tax: $20.00</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart" type="button" title="Add to Cart" onclick="cart.add('33')">
															<i class="material-icons">add</i><span class="hidden-xs hidden-sm hidden-md"><a href="{{route('client.shopping_cart.details',['id'=>"tempora+incidunt+utlabore"])}}">Add to Cart</a> </span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('33');">
															<i class="material-icons icon-wishlist">favorite</i>
															<span title="Add to Wish List">Add to Wish List</span>
															<span class="loading"><i class="material-icons">cached</i></span>
														</button>
														...
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=33')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
								...
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"voluptas+nulla+pariatur"])}}">
												<img
													class="image_thumb"
													src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/17-371x482.jpg"
										...
										<div class="thumb-description">
											<div class="caption">
												...
												<div class="product-price-and-shipping">
													<div class="price"><span class="price-new">$20.00</span> <span class="price-old">$1,000.00</span> <span class="price-tax">Ex Tax: $20.00</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart disabled" type="button" title="Out Of Stock" onclick="">
															<i class="material-icons">add</i><span class="out of stock"><a href="{{route('client.shopping_cart.details',['id'=>"voluptas+nulla+pariatur"])}}">Add to cart</a></span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('46');">
															<i class="material-icons icon-wishlist">favorite</i>
															<span title="Add to Wish List">Add to Wish List</span>
															<span class="loading"><i class="material-icons">cached</i></span>
														</button>
														<button class="btn-compare" title="Add to compare" onclick="compare.add('46');">
															<i class="material-icons icon-exchange">equalizer</i>
															<span title="Add to compare">Add to compare</span>
															<span class="loading"><i class="material-icons">cached</i></span>
														</button>
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=46')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
								...
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"voluptas+sit+aspernatur"])}}">
												<img
													class="image_thumb"
													src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/18-371x482.jpg"
										...
										<div class="thumb-description">
											<div class="caption">
												<div class="product-description">
													...
													<p class="description">More room to move. With 80GB or 160GB of storage and up to 40 hours of battery life, the new..</p>
												</div>
												<div class="product-price-and-shipping">
													<div class="price">$100.00 <span class="price-tax">Ex Tax: $100.00</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart" type="button" title="Add to Cart" onclick="cart.add('48')">
															<i class="material-icons">add</i><span class="hidden-xs hidden-sm hidden-md"><a href="{{route('client.shopping_cart.details',['id'=>"voluptas+sit+aspernatur"])}}">Add to Cart</a> </span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('48');">
															<i class="material-icons icon-wishlist">favorite</i>
															<span title="Add to Wish List">Add to Wish List</span>
															<span class="loading"><i class="material-icons">cached</i></span>
														</button>
														...
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=48')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
								...
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"voluptate+velit+esse"])}}">
												<img
													class="image_thumb"
													src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-371x482.jpg"
													title="voluptate velit esse"
													alt="voluptate velit esse"
												/>
												<img
										...
										<div class="thumb-description">
											<div class="caption">
												<div class="product-description">
													<h4><a href="{{route('client.shopping_cart.details',['id'=>"voluptate+velit+esse"])}}">voluptate velit esse</a></h4>
												...
												<div class="product-price-and-shipping">
													<div class="price">$101.00 <span class="price-tax">Ex Tax: $101.00</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart" type="button" title="Add to Cart" onclick="cart.add('40')">
															<i class="material-icons">add</i><span class="hidden-xs hidden-sm hidden-md"><a href="{{route('client.shopping_cart.details',['id'=>"voluptate+velit+esse"])}}">Add to Cart</a> </span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('40');">
															<i class="material-icons icon-wishlist">favorite</i>
															<span title="Add to Wish List">Add to Wish List</span>
															<span class="loading"><i class="material-icons">cached</i></span>
														</button>
														...
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=40')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
								...
								<div class="product-layout product-list col-xs-12">
									<div class="product-thumb row">
										<div class="image">
											<a href="{{route('client.shopping_cart.details',['id'=>"suscipit+laboriosam+nisi"])}}">
												<img
													class="image_thumb"
													src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/20-371x482.jpg"
										...
										<div class="thumb-description">
											<div class="caption">
												...
												<div class="product-price-and-shipping">
													<div class="price">$199.99 <span class="price-tax">Ex Tax: $199.99</span></div>
												</div>
												<div class="ttproducthover">
													<div class="ttcart">
														<button class="btn-cart disabled" type="button" title="Out Of Stock" onclick="">
															<i class="material-icons">add</i><span class="out of stock"><a href="{{route('client.shopping_cart.details',['id'=>"suscipit+laboriosam+nisi"])}}">Add to cart</a> </span><span class="loading"><i class="material-icons">cached</i></span>
														</button>
													</div>
													<div class="button-group">
														<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('49');">
															<i class="material-icons icon-wishlist">favorite</i>
															<span title="Add to Wish List">Add to Wish List</span>
															<span class="loading"><i class="material-icons">cached</i></span>
														</button>
														...
														<button
															...
															type="button"
															title=""
															onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=49')"
														>
															<i class="material-icons quick_view_icon">visibility</i>
															<span title=""></span>
															<span class="loading"><i class="material-icons">cached</i></span>
						...
						<div class="category-pagination">
							...
							<div class="col-xs-6 text-right">
								<ul class="pagination">
									<li><a href="{{route('client.product.petuntse',['id'=>'all_petuntse'])}}">|&lt;</a></li>
									
									<li><a href="{{route('client.product.petuntse',['id'=>'all_petuntse'])}}">1</a></li>
