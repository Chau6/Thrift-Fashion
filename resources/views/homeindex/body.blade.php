                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='aliquam+quaerat+voluptatem')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/01-380x494.jpg"
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='aspetur+autodit+autfugit')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/04-380x494.jpg"
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <div class="ttproducthover">
                                                        ...
                                                        <div class="button-group">
                                                            ...
                                                            <button class="btn-quickview" type="button" title="" onclick="tt_quickview.ajaxView('{{route('client.shopping_cart.details',$id='aspetur+autodit+autfugit')}}')">
                                                                <i class="material-icons quick_view_icon">visibility</i>
                                                                <span title=""></span>
                                                                <span class="loading"><i class="material-icons">cached</i></span>
                                                            </button>
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='magni+dolores+eosquies')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/05-380x494.jpg"
                                                ...
                                                <div class="caption">
                                                    ...
                                                    <div class="ttproducthover">
                                                        ...
                                                        <div class="button-group">
                                                            ...
                                                            <button class="btn-quickview" type="button" title="" onclick="tt_quickview.ajaxView('{{route('client.shopping_cart.details',$id='magni+dolores+eosquies')}}')">
                                                                <i class="material-icons quick_view_icon">visibility</i>
                                                                <span title=""></span>
                                                                <span class="loading"><i class="material-icons">cached</i></span>
                                                            </button>
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='voluptas+nulla+pariatur')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/17-380x494.jpg"
                                            ...
                                            <div class="thumb-description">
                                                <div class="caption">
                                                    ...
                                                    <div class="price">
                                                        <span class="price-new">$26.00</span> <span class="price-old">$1,202.00</span>
                                                        <span class="price-tax">Without tax: $20.00</span>
                                                    </div>
                                                    <div class="ttproducthover">
                                                        <div class="ttcart">
                                                        ...
                                                        <div class="button-group">
                                                            <button class="btn-wishlist" title="Add to wishlist" onclick="wishlist.add('46');">
                                                                <i class="material-icons icon-wishlist">favorite</i>
                                                                <span title="Add to wishlist">Add to wishlist</span>
                                                                <span class="loading"><i class="material-icons">cached</i></span>
                                                            </button>
                                                            ...
                                                            <button
                                                                ...
                                                                type="button"
                                                                title=""
                                                                onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=46')"
                                                            >
                                                                <i class="material-icons quick_view_icon">visibility</i>
                                                                <span title=""></span>
                                                                <span class="loading"><i class="material-icons">cached</i></span>
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='voluptate+velit+esse')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-380x494.jpg"
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='suscipit+laboriosam+nisi')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/20-380x494.jpg"
                                                        title="suscipit laboriosam nisi"
                                                        alt="suscipit laboriosam nisi"
                                                    />
                                                    <img class="image_thumb_swap" src="{{asset('images/nisi.jpg')}}" title="suscipit laboriosam nisi" alt="suscipit laboriosam nisi" />
                                                </a>
                                            </div>
                                            <div class="thumb-description">
                                                <div class="caption">
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='voluptas+sit+aspernatur')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/18-380x494.jpg"
                                                        title="voluptas sit aspernatur"
                                                        alt="voluptas sit aspernatur"
                                                    />
                                                    <img class="image_thumb_swap" src="{{asset('images/chanvay.jpg')}}" title="voluptas sit aspernatur" alt="voluptas sit aspernatur" />
                                                </a>
                                            </div>
                                            <div class="thumb-description">
                                                <div class="caption">
                                                    ...
                                                    <div class="ttproducthover">
                                                        ...
                                                        <div class="button-group">
                                                            ...
                                                            <button
                                                                ...
                                                                type="button"
                                                                title=""
                                                                onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=48')"
                                                            >
                                                                <i class="material-icons quick_view_icon">visibility</i>
                                                                <span title=""></span>
                                                                <span class="loading"><i class="material-icons">cached</i></span>
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='cool+fabric+wide+cheesecloth')}}">
                                                    <img class="image_thumb" src="{{asset('images/aophong.jpg')}}" title="aliquam quat voluptatem" alt="aliquam quat voluptatem" />
                                                    <img class="image_thumb_swap" src="{{asset('images/aophong.jpg')}}" title="aliquam quat voluptatem" alt="aliquam quat voluptatem" />
                                                </a>
                                                <div class="sale-icon">Sale</div>
                                            ...
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='voluptas+nulla+pariatur')}}">
                                                    <img
                                                        ...
                                                        alt="voluptas nulla pariatur"
                                                    />
                                                    <img class="image_thumb_swap" src="{{asset('images/daibang.jpg')}}" title="voluptas nulla pariatur" alt="voluptas nulla pariatur" />
                                                </a>
                                                <div class="sale-icon">Sale</div>
                                                <span class="percent">-98%</span>
                                            </div>
                                        ...
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a>
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/11-380x494.jpg"
                                                        title="quis autem veleuminium"
                                                        alt="quis autem veleuminium"
                                                    />
                                                    <img class="image_thumb_swap" src="{{asset('images/dongu.jpg')}}" title="quis autem veleuminium" alt="quis autem veleuminium" />
                                                </a>
                                            </div>
                                            <div class="thumb-description">
                                                <div class="caption">
                            ...
                            <div id="tab-bestseller-0" class="tab-pane">
                                <div id="owl3" class="products-carousel">
                                    ...
                                    <div class="product-layouts">
                                        <div class="product-thumb transition">
                                            <div class="image">
                                                <a href="{{route('client.shopping_cart.details',$id='quis+autem+veleuminium')}}">
                                                    <img
                                                        class="image_thumb"
                                                        src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/11-380x494.jpg"
                                                        title="quis autem veleuminium"
        ...
        <div class="html-content">
            <div class="box-content">
                <div id="ttcmsparallax">
                    <div
                        class="parallex"
                        data-source-url="image/catalog/demo/banners/parallax-bg.jpg"
                        style="background-image: url('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/catalog/demo/banners/parallax-bg.jpg'); background-position: 50% 65.8718%;"
                    >
                            ...
                            <div class="product-thumb transition">
                                <div class="image">
                                    <a href="{{route('client.shopping_cart.details',$id='cool+fabric+wide+cheesecloth')}}">
                                        <img
                                            class="image_thumb"
                                            src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/03-298x387.jpg"
                            ...
                            <div class="product-thumb transition">
                                <div class="image">
                                    <a href="{{route('client.shopping_cart.details',$id='aspetur+autodit+autfugit')}}">
                                        <img
                                            class="image_thumb"
                                            src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/04-298x387.jpg"
                                            title="aspetur autodit autfugit"
                                            alt="aspetur autodit autfugit"
                                        />
                                        <img
                            ...
                            <div class="product-thumb transition">
                                <div class="image">
                                    <a href="{{route('client.shopping_cart.details',$id='perspiciatis+unde+omnis')}}">
                                        <img
                                            class="image_thumb"
                                            src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-298x387.jpg"
                                ...
                                <div class="thumb-description">
                                    <div class="caption">
                                        ...
                                        <div class="price">
                                            <span class="price-new">$8.00</span> <span class="price-old">$14.00</span>
                            ...
                            <div class="product-thumb transition">
                                <div class="image">
                                    <a href="{{route('client.shopping_cart.details',$id='tempora+incidunt+utlabore')}}">
                                        <img
                                            class="image_thumb"
                                            src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/16-298x387.jpg"
                                ...
                                <div class="thumb-description">
                                    <div class="caption">
                                        ...
                                        <div class="price">
                                            <span class="price-new">$26.00</span> <span class="price-old">$242.00</span>
                                            <span class="price-tax">Ex Tax: $20.00</span>
                                        </div>
                                        <div class="ttproducthover">
                                            <div class="ttcart">
                                            ...
                                            <div class="button-group">
                                                ...
                                                <button
                                                    ...
                                                    type="button"
                                                    title=""
                                                    onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=33')"
                                                >
                                                    <i class="material-icons quick_view_icon">visibility</i>
                                                    <span title=""></span>
                                                    <span class="loading"><i class="material-icons">cached</i></span>
                            ...
                            <div class="product-thumb transition">
                                <div class="image">
                                    <a href="{{route('client.shopping_cart.details',$id='voluptas+nulla+pariatur')}}">
                                        <img
                                            class="image_thumb"
                                            src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/17-298x387.jpg"
                                            title="voluptas nulla pariatur"
                                            alt="voluptas nulla pariatur"
                                        />
                                        <img
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="subbanner col-xs-6">
                                <a> <img src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/catalog/demo/banners/subbanner-1.jpg" alt="subbanner-1" width="630" height="390" /></a>
                            ...
                            <div class="subbanner col-xs-6">
                                <a> <img src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/catalog/demo/banners/subbanner-2.jpg" alt="subbanner-2" width="630" height="390" /></a>
