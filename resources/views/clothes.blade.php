                           ...
                           <div class="swiper-viewport">
                              <div id="banner0" class="swiper-container">
                                 <div class="swiper-wrapper">
                                    <div class="swiper-slide">                                            <a><img src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/banners/left-banner-300x450.jpg" alt="Left-Banner" class="img-responsive" /></a></div>
                                 </div>
                              </div>
                           </div>
                           <script><!--
