		...
		<div id="page">
			...
			<div id="product-product" class="container product-product">
				<ul class="breadcrumb">
					...
					<li><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=34">gray hoodie</a></li>
				</ul>
				<div class="row">
					<div id="content" class="col-sm-12">
						<h1 class="page-title">gray hoodie</h1>
