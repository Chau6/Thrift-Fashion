...
<html dir="ltr" lang="en">
    <head>
        ...
        <link href="{{route('client.shopping_cart.details',$id='aspetur+autodit+autfugit')}}" rel="canonical" />
                    ...
                    <div id="content" class="col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-7 col-md-7 product-details">
                                ...
                                <div class="addthis_toolbox addthis_default_style" data-url="{{route('client.shopping_cart.details',$id='aspetur+autodit+autfugit')}}">
