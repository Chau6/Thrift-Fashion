...
<html dir="ltr" lang="en">
	...
	<head>
		...
		<title>aspetur autodit autfugit</title>
		...
		<link href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=28" rel="canonical" />
		...
		<div id="page">
											...
											<li class="ttlanguage">
												<div class="pull-left">
													<form action="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
														...
														<input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=28" />
													</form>
												</div>
											</li>
											<li class="ttcurrency">
							...
							<div class="header-left-cms">
								<aside id="header-left">
									<div class="main-category-list">
										...
										<div class="tt-menu horizontal-menu tt-menu-bar" id="tt-menu-1917">
			...
			<div id="product-product" class="container product-product">
				<ul class="breadcrumb">
					...
					<li><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=28">aspetur autodit autfugit</a></li>
				</ul>
				<div class="row">
					<div id="content" class="col-sm-12">
						<h1 class="page-title">aspetur autodit autfugit</h1>

						<div class="row">
							<div class="col-xs-12 col-sm-5 col-md-5 product-images">
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/04-800x1040.jpg" title="aspetur autodit autfugit">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/04-800x1040.jpg"
											...
											<span class="product-percent">-80%</span>
										</a>
									</div>
									<div class="additional-images-container">
										<div class="additional-images">
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/07--800x1040.jpg" title="aspetur autodit autfugit">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/03--800x1040.jpg" title="aspetur autodit autfugit">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/08-800x1040.jpg" title="aspetur autodit autfugit">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/02--800x1040.jpg" title="aspetur autodit autfugit">
													<img
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								<h1 class="product-name">aspetur autodit autfugit</h1>
								...
								<table class="product-info">
									<tr>
										<td>Brands</td>
										<td class="product-info-value"><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/manufacturer/info&amp;manufacturer_id=5">HTC</a></td>
									</tr>
									<tr>
										<td>Product Code:</td>
										<td class="product-info-value">Product 1</td>
									</tr>
									<tr>
										<td>Reward Points:</td>
										<td class="product-info-value">400</td>
									</tr>
									<tr>
										<td>Availability:</td>
								...
								<ul class="list-unstyled product-price">
									<li>
										<h2 class="price-new">$20.00</h2>
									</li>
									<li><span class="price-old">$100.00</span></li>
									<li class="product-tax">Ex Tax: $20.00</li>
									<li class="product-reward-points">Price in reward points: 200</li>
									<li>
										<ul class="product-discounts">
											<li>2 or more $75.00</li>
											<li>5 or more $50.00</li>
										</ul>
									</li>
								</ul>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('28');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('28');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=28">
					...
					<div class="col-sm-12 product-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-description">
								<p>
									HTC Touch - in High Definition. Watch music videos and streaming content in awe-inspiring high definition clarity for a mobile experience you never thought possible. Seductively sleek, the HTC Touch HD
									provides the next generation of mobile functionality, all at a simple touch. Fully integrated with Windows Mobile Professional 6.1, ultrafast 3.5G, GPS, 5MP camera, plus lots more - all delivered on a
									breathtakingly crisp 3.8&quot; WVGA touchscreen - you can take control of your mobile world with the HTC Touch HD.
								</p>
								<p>
					...
					<div class="related-carousel products-list col-sm-12">
						...
						<div class="related-items products-carousel row">
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=34">
											<img
												class="image_thumb"
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/07-371x482.jpg"
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=34')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=45">
											<img
												class="image_thumb"
									...
									<div class="thumb-description">
										<div class="caption">
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('45');">
														<i class="material-icons icon-wishlist">favorite</i>
														<span title="Add to Wish List">Add to Wish List</span>
														<span class="loading"><i class="material-icons">cached</i></span>
													</button>
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=45')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#5f323631361f2b3a322f333e2b3a2b2d362f713c3032">
																<span class="__cf_email__" data-cfemail="ddb9b8b0b29dbab0bcb4b1f3beb2b0">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
