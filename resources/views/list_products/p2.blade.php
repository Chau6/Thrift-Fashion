...
<html dir="ltr" lang="en">
	...
	<head>
		...
		<title>South VietNamese Pajama</title>
		...
		<link href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=30" rel="canonical" />
		...
		<div id="page">
											...
											<li class="ttlanguage">
												<div class="pull-left">
													<form action="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
														...
														<input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=30" />
													</form>
												</div>
											</li>
											<li class="ttcurrency">
													...
													<table class="table table-striped">
														<tr>
															...
															<td class="text-left name">
																<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=42">south+vietnamese+pajama</a> <br />
							...
							<div class="header-left-cms">
								<aside id="header-left">
									<div class="main-category-list">
										...
										<div class="tt-menu horizontal-menu tt-menu-bar" id="tt-menu-6527">
			...
			<div id="product-product" class="container product-product">
				<ul class="breadcrumb">
					...
					<li><a href="{{route('client.product.petuntse',$id='petuntse')}}">Petuntse</a></li>
					<li><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=30">south vietnamese pajama</a></li>
				</ul>
				<div class="row">
					<div id="content" class="col-sm-12">
						<h1 class="page-title">South VietNamese Pajama</h1>

						<div class="row">
							<div class="col-xs-12 col-sm-5 col-md-5 product-images">
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/02-800x1040.jpg" title="aliquam quaerat voluptem">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/02-800x1040.jpg"
									...
									<div class="additional-images-container">
										<div class="additional-images">
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/10-800x1040.jpg" title="aliquam quaerat voluptem">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/08-800x1040.jpg" title="aliquam quaerat voluptem">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/08-371x482.jpg"
														title="aliquam quaerat voluptem"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/08-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/08-800x1040.jpg"
														alt="aliquam quaerat voluptem"
													/>
												</a>
											</div>
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-800x1040.jpg" title="aliquam quaerat voluptem">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-371x482.jpg"
														title="aliquam quaerat voluptem"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-800x1040.jpg"
														alt="aliquam quaerat voluptem"
													/>
												</a>
											</div>
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/01-800x1040.jpg" title="aliquam quaerat voluptem">
													<img
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								<h1 class="product-name">south vietNamese pajama</h1>
								...
								<table class="product-info">
									<tr>
										<td>Brands</td>
										<td class="product-info-value"><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/manufacturer/info&amp;manufacturer_id=9">Canon</a></td>
									</tr>
									<tr>
										<td>Product Code:</td>
										<td class="product-info-value">Product 3</td>
									</tr>
									<tr>
										<td>Reward Points:</td>
										<td class="product-info-value">200</td>
									</tr>
									<tr>
										<td>Availability:</td>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('30');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('30');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=30">
					...
					<div class="col-sm-12 product-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-description">
								<p>
									Canon's press material for the EOS 5D states that it 'defines (a) new D-SLR category', while we're not typically too concerned with marketing talk this particular statement is clearly pretty accurate. The
									EOS 5D is unlike any previous digital SLR in that it combines a full-frame (35 mm sized) high resolution sensor (12.8 megapixels) with a relatively compact body (slightly larger than the EOS 20D, although
									in your hand it feels noticeably 'chunkier'). The EOS 5D is aimed to slot in between the EOS 20D and the EOS-1D professional digital SLR's, an important difference when compared to the latter is that the
									EOS 5D doesn't have any environmental seals. While Canon don't specifically refer to the EOS 5D as a 'professional' digital SLR it will have obvious appeal to professionals who want a high quality digital
									SLR in a body lighter than the EOS-1D. It will also no doubt appeal to current EOS 20D owners (although lets hope they've not bought too many EF-S lenses...) äë
								</p>
							</div>
						...
						<div class="related-items products-carousel row">
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=28">
											<img
												class="image_thumb"
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=28')"
													>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=29">
											<img
												class="image_thumb"
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/13-371x482.jpg"
									...
									<div class="thumb-description">
										<div class="caption">
											<h4><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=29">similique suntin culpaqui</a></h4>
											<div class="price">
												$279.99
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('29');">
														<i class="material-icons icon-wishlist">favorite</i>
														<span title="Add to Wish List">Add to Wish List</span>
														<span class="loading"><i class="material-icons">cached</i></span>
													</button>
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=29')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=30">
											<img
												class="image_thumb"
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/02-371x482.jpg"
												title="aliquam quaerat voluptem"
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=30')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=35">
											<img
												class="image_thumb"
									...
									<div class="thumb-description">
										<div class="caption">
											<h4><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=35">sint incidunt utlabore</a></h4>
											<div class="price">
												$100.00
												<span class="price-tax">Ex Tax: $100.00</span>
											</div>
											<div class="ttproducthover">
												...
												<div class="button-group">
													<button class="btn-wishlist" title="Add to Wish List" onclick="wishlist.add('35');">
														<i class="material-icons icon-wishlist">favorite</i>
														<span title="Add to Wish List">Add to Wish List</span>
														<span class="loading"><i class="material-icons">cached</i></span>
													</button>
													<button class="btn-compare" title="Add to compare" onclick="compare.add('35');">
														<i class="material-icons icon-exchange">equalizer</i>
														<span title="Add to compare">Add to compare</span>
														<span class="loading"><i class="material-icons">cached</i></span>
													</button>
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=35')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=36">
											<img class="image_thumb" src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/06-371x482.jpg" title="neque porro quisquam" alt="neque porro quisquam" />
											<img
												class="image_thumb_swap"
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=36')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=41">
											<img
												class="image_thumb"
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=41')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=47">
											<img
												class="image_thumb"
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=47')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#711c181f183105141c011d100514050318015f121e1c">
																<span class="__cf_email__" data-cfemail="93f7f6fefcd3f4fef2faffbdf0fcfe">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
