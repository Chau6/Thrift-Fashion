...
<html dir="ltr" lang="en">
	...
	<head>
		...
		<link href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=47" rel="canonical" />
											...
											<li class="ttlanguage">
												<div class="pull-left">
													<form action="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
														...
														<input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=47" />
													</form>
												</div>
											</li>
											<li class="ttcurrency">
							...
							<div class="header-left-cms">
								<aside id="header-left">
									<div class="main-category-list">
										...
										<div class="tt-menu horizontal-menu tt-menu-bar" id="tt-menu-276">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-5 col-md-5 product-images">
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/03-800x1040.jpg" title="aliquam quat voluptatem">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/03-800x1040.jpg"
									...
									<div class="additional-images-container">
										<div class="additional-images">
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/18-800x1040.jpg" title="aliquam quat voluptatem">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/18-371x482.jpg"
														title="aliquam quat voluptatem"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/18-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/18-800x1040.jpg"
														alt="aliquam quat voluptatem"
													/>
												</a>
											</div>
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/17-800x1040.jpg" title="aliquam quat voluptatem">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/17-371x482.jpg"
														title="aliquam quat voluptatem"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/17-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/17-800x1040.jpg"
														alt="aliquam quat voluptatem"
													/>
												</a>
											</div>
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/05-800x1040.jpg" title="aliquam quat voluptatem">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/16-800x1040.jpg" title="aliquam quat voluptatem">
													<img
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								...
								<table class="product-info">
									<tr>
										<td>Brands</td>
										<td class="product-info-value"><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/manufacturer/info&amp;manufacturer_id=7">Hewlett-Packard</a></td>
									</tr>
									<tr>
										<td>Product Code:</td>
										<td class="product-info-value">Product 21</td>
									</tr>
									<tr>
										<td>Reward Points:</td>
										<td class="product-info-value">300</td>
									</tr>
									<tr>
										<td>Availability:</td>
								...
								<ul class="list-unstyled product-price">
									<li>
										<h2 class="price-new">$80.00</h2>
									</li>
									<li><span class="price-old">$100.00</span></li>
									<li class="product-tax">Ex Tax: $80.00</li>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('47');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('47');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=47">
					...
					<div class="col-sm-12 product-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-description">
								<p>
									Stop your co-workers in their tracks with the stunning new 30-inch diagonal HP LP3065 Flat Panel Monitor. This flagship monitor features best-in-class performance and presentation features on a huge
									wide-aspect screen while letting you work as comfortably as possible - you might even forget you&#39;re at the office
								</p>
							</div>
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#a8c5c1c6c1e8dccdc5d8c4c9dccddcdac1d886cbc7c5">
																<span class="__cf_email__" data-cfemail="6a0e0f07052a0d070b030644090507">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
