...
<html dir="ltr" lang="en">
	...
	<head>
		...
		<title>voluptate velit esse</title>
											...
											<li class="ttlanguage">
												<div class="pull-left">
													<form action="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
														...
														<input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=40" />
													</form>
												</div>
											</li>
											<li class="ttcurrency">
							...
							<div class="header-left-cms">
								<aside id="header-left">
									<div class="main-category-list">
										...
										<div class="tt-menu horizontal-menu tt-menu-bar" id="tt-menu-3687">
			...
			<div id="product-product" class="container product-product">
				...
				<div class="row">
					<div id="content" class="col-sm-12">
						<h1 class="page-title">voluptate velit esse</h1>

						<div class="row">
							<div class="col-xs-12 col-sm-5 col-md-5 product-images">
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-800x1040.jpg" title="voluptate velit esse">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-800x1040.jpg"
												title="voluptate velit esse"
												data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-800x1040.jpg"
									...
									<div class="additional-images-container">
										<div class="additional-images">
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-800x1040.jpg" title="voluptate velit esse">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-800x1040.jpg"
														title="voluptate velit esse"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/19-800x1040.jpg"
														alt="voluptate velit esse"
													/>
												</a>
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/03-800x1040.jpg" title="voluptate velit esse">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/11-800x1040.jpg" title="voluptate velit esse">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/16-800x1040.jpg" title="voluptate velit esse">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/02-800x1040.jpg" title="voluptate velit esse">
													<img
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								<h1 class="product-name">voluptate velit esse</h1>
								...
								<table class="product-info">
									...
									<tr>
										<td>Product Code:</td>
										<td class="product-info-value">product 11</td>
									</tr>
									<tr>
										<td>Availability:</td>
								...
								<ul class="list-unstyled product-price">
									...
									<li class="product-tax">Ex Tax: $101.00</li>
								</ul>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('40');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('40');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=40">
					...
					<div class="col-sm-12 product-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-description">
								<p class="intro">
									iPhone is a revolutionary new mobile phone that allows you to make a call by simply tapping a name or number in your address book, a favorites list, or a call log. It also automatically syncs all your
									contacts from a PC, Mac, or Internet service. And it lets you select and listen to voicemail messages in whatever order you want just like email.
								</p>
							</div>
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#b4d9dddaddf4c0d1d9c4d8d5c0d1c0c6ddc49ad7dbd9">
																<span class="__cf_email__" data-cfemail="ef8b8a8280af88828e8683c18c8082">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
