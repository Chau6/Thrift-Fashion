...
<html dir="ltr" lang="en">
	...
	<head>
		...
		<title>magni dolores eosquies</title>
		...
		<link href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=41" rel="canonical" />
		...
		<div id="page">
											...
											<li class="ttlanguage">
												<div class="pull-left">
													<form action="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
														...
														<input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=41" />
													</form>
												</div>
											</li>
											<li class="ttcurrency">
							...
							<div class="header-left-cms">
								<aside id="header-left">
									<div class="main-category-list">
										...
										<div class="tt-menu horizontal-menu tt-menu-bar" id="tt-menu-5975">
			...
			<div id="product-product" class="container product-product">
				<ul class="breadcrumb">
					...
					<li><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=41">magni dolores eosquies</a></li>
				</ul>
				<div class="row">
					<div id="content" class="col-sm-12">
						<h1 class="page-title">magni dolores eosquies</h1>

						<div class="row">
							<div class="col-xs-12 col-sm-5 col-md-5 product-images">
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/05-800x1040.jpg" title="magni dolores eosquies">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/05-800x1040.jpg"
									...
									<div class="additional-images-container">
										<div class="additional-images">
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/10-800x1040.jpg" title="magni dolores eosquies">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/04-800x1040.jpg" title="magni dolores eosquies">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/08-800x1040.jpg" title="magni dolores eosquies">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/16-800x1040.jpg" title="magni dolores eosquies">
													<img
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								<h1 class="product-name">magni dolores eosquies</h1>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('41');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('41');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=41">
					...
					<div class="col-sm-12 product-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-description">
								<div>
									Just when you thought iMac had everything, now there´s even more. More powerful Intel Core 2 Duo processors. And more memory standard. Combine this with Mac OS X Leopard and iLife ´08, and it´s more
									all-in-one than ever. iMac packs amazing performance into a stunningly slim space.
								</div>
							</div>
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#acc1c5c2c5ecd8c9c1dcc0cdd8c9d8dec5dc82cfc3c1">
																<span class="__cf_email__" data-cfemail="82e6e7efedc2e5efe3ebeeace1edef">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
