						...
						<div class="row">
								...
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/14-800x1040.jpg" title="sint incidunt utlabore">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/14-800x1040.jpg"
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								...
								<table class="product-info">
									<tr>
										<td>Product Code:</td>
										<td class="product-info-value">Product 8</td>
									</tr>
									<tr>
										<td>Availability:</td>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('35');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('35');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=35">
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#2b464245426b5f4e465b474a5f4e5f59425b05484446">
																<span class="__cf_email__" data-cfemail="b7d3d2dad8f7d0dad6dedb99d4d8da">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
