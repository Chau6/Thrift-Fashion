...
<html dir="ltr" lang="en">
	...
	<head>
		...
		<title>perspiciatis unde omnis</title>
		...
		<link href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=43" rel="canonical" />
		...
		<div id="page">
			...
			<div id="product-product" class="container product-product">
				<ul class="breadcrumb">
					...
					<li><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;path=20&amp;product_id=43">perspiciatis unde omnis</a></li>
				</ul>
				<div class="row">
					<div id="content" class="col-sm-12">
						<h1 class="page-title">perspiciatis unde omnis</h1>

						<div class="row">
							<div class="col-xs-12 col-sm-5 col-md-5 product-images">
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-800x1040.jpg" title="perspiciatis unde omnis">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-800x1040.jpg"
									...
									<div class="additional-images-container">
										<div class="additional-images">
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/05-800x1040.jpg" title="perspiciatis unde omnis">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/04-800x1040.jpg" title="perspiciatis unde omnis">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/03-800x1040.jpg" title="perspiciatis unde omnis">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/12-800x1040.jpg" title="perspiciatis unde omnis">
													<img
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								...
								<table class="product-info">
									...
									<tr>
										<td>Reward Points:</td>
										<td class="product-info-value">600</td>
									</tr>
									<tr>
										<td>Availability:</td>
								...
								<ul class="list-unstyled product-price">
									<li>
										<h2 class="price-new">$5.00</h2>
									</li>
									<li><span class="price-old">$10.00</span></li>
									<li class="product-tax">Ex Tax: $5.00</li>
								</ul>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('43');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('43');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=43">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-description">
								<div>
									...
									<p>
										MacBook makes it easy to hit the road thanks to its tough polycarbonate case, built-in wireless technologies, and innovative MagSafe Power Adapter that releases automatically if someone accidentally
										trips on the cord.
									</p>
									<p>
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#264b4f484f6652434b564a47524352544f560845494b">
																<span class="__cf_email__" data-cfemail="7014151d1f30171d11191c5e131f1d">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
