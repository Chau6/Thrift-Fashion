...
<html dir="ltr" lang="en">
	...
	<head>
		...
		<link href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=36" rel="canonical" />
							...
							<div class="header-left-cms">
								<aside id="header-left">
									<div class="main-category-list">
										...
										<div class="tt-menu horizontal-menu tt-menu-bar" id="tt-menu-613">
			...
			<div id="product-product" class="container product-product">
				...
				<div class="row">
					<div id="content" class="col-sm-12">
						<h1 class="page-title">neque porro quisquam</h1>

						<div class="row">
							<div class="col-xs-12 col-sm-5 col-md-5 product-images">
								<div class="thumbnails">
									<div class="product-image">
										<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/06-800x1040.jpg" title="neque porro quisquam">
											<img
												src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/06-800x1040.jpg"
									...
									<div class="additional-images-container">
										<div class="additional-images">
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/07-800x1040.jpg" title="neque porro quisquam">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/07-371x482.jpg"
														title="neque porro quisquam"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/07-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/07-800x1040.jpg"
														alt="neque porro quisquam"
													/>
												</a>
											</div>
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/13-800x1040.jpg" title="neque porro quisquam">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/13-371x482.jpg"
														title="neque porro quisquam"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/13-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/13-800x1040.jpg"
														alt="neque porro quisquam"
													/>
												</a>
											</div>
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/09-800x1040.jpg" title="neque porro quisquam">
													<img
											...
											<div class="image-additional">
												<a class="thumbnail" href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/15-800x1040.jpg" title="neque porro quisquam">
													<img
														src="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/15-371x482.jpg"
														title="neque porro quisquam"
														data-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/15-800x1040.jpg"
														data-zoom-image="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/image/cache/catalog/demo/product/15-800x1040.jpg"
														alt="neque porro quisquam"
													/>
												</a>
											</div>
							...
							<div class="col-xs-12 col-sm-7 col-md-7 product-details">
								<h1 class="product-name">neque porro quisquam</h1>
								...
								<table class="product-info">
									<tr>
										<td>Brands</td>
										<td class="product-info-value"><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/manufacturer/info&amp;manufacturer_id=8">Apple</a></td>
									</tr>
									<tr>
										<td>Product Code:</td>
										<td class="product-info-value">Product 9</td>
									</tr>
									<tr>
										<td>Availability:</td>
								...
								<ul class="list-unstyled product-price">
									...
									<li class="product-reward-points">Price in reward points: 100</li>
								</ul>
								...
								<div class="btn-group">
									<button class="btn btn-default product-btn-wishlist" type="button" class="btn btn-default" title="Add to Wish List" onclick="wishlist.add('36');">
										<i class="material-icons favorite">favorite_border</i>
										Add to Wish List
									</button>
									<button class="btn btn-default product-btn-compare" type="button" class="btn btn-default" title="Add to compare" onclick="compare.add('36');">
										<i class="material-icons compare-arrows">compare_arrows</i>
										Add to compare
									</button>
								</div>

								<div class="addthis_toolbox addthis_default_style" data-url="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=36">
					...
					<div class="col-sm-12 product-tabs">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tab-description">
								<div>
									<p>
										<strong>Video in your pocket.</strong>
									</p>
									<p>
									...
									<p>
										<strong>Sleek and colorful.</strong>
									</p>
									<p>
									...
									<p>
										Available as a free download, iTunes makes it easy to browse and buy millions of songs, movies, TV shows, audiobooks, and games and download free podcasts all at the iTunes Store. And you can import
										your own music, manage your whole media library, and sync your iPod or iPhone with ease.
									</p>
								</div>
							</div>
					...
					<div class="related-carousel products-list col-sm-12">
						...
						<div class="related-items products-carousel row">
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=44">
											<img
												class="image_thumb"
									...
									<div class="thumb-description">
										<div class="caption">
											<h4><a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=44">quaerat outt voluptatem</a></h4>
											<div class="price">
												$1,000.00
											...
											<div class="ttproducthover">
												...
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=44')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
							...
							<div class="product-layouts">
								<div class="product-thumb transition">
									<div class="image">
										<a href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=49">
											<img
												class="image_thumb"
											...
											<div class="ttproducthover">
												<div class="ttcart">
													<button class="btn-cart disabled" type="button" title="Out Of Stock" onclick="">
														<i class="material-icons">add</i><span class="out of stock">Out Of Stock </span><span class="loading"><i class="material-icons">cached</i></span>
													</button>
												</div>
												<div class="button-group">
													...
													<button
														...
														type="button"
														title=""
														onclick="tt_quickview.ajaxView('https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/product&amp;product_id=49')"
													>
														<i class="material-icons quick_view_icon">visibility</i>
														<span title=""></span>
														<span class="loading"><i class="material-icons">cached</i></span>
												...
												<li class="email col-sm-4">
													<div class="data email">
														...
														<span class="email-address">
															<a href="/cdn-cgi/l/email-protection#761b1f181f3602131b061a17021302041f065815191b">
																<span class="__cf_email__" data-cfemail="b6d2d3dbd9f6d1dbd7dfda98d5d9db">[email&#160;protected]</span>
															</a>
														</span>
													</div>
												</li>
