											 ...
											 <li class="li-top-item mega-menu">
											   ...
											   <div class="flyout-menu-container sub-menu-container">
												  <ul class="ul-second-items">
													 ...
													 <li class="li-second-items">
													   <a href="{{route('client.product.petuntse',['id'=>"petuntse_2"])}}" class="a-second-link a-item">
													 ...
													 <li class="li-second-items">
													   <a href="{{route('client.product.girl',['id'=>"girls_3"])}}" class="a-second-link a-item">
														<span class="a-second-title">Girls</span>
														</a>
													 </li>
													 <li class="li-second-items">
													   <a href="{{route('client.product.kurti',['id'=>"kurti_4"])}}" class="a-second-link a-item">
