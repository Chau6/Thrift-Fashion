<!DOCTYPE html>
    <html dir="ltr" lang="en">
         <head>
            ...
            <link href="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/category&amp;path=67" rel="canonical" />
                                       ...
                                       {{-- <li class="ttlanguage">
                                          <div class="pull-left">
                                             <form action="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=common/language/language" method="post" enctype="multipart/form-data" id="form-language">
                                                ...
                                                <input type="hidden" name="redirect" value="https://opencart.templatetrip.com/OPC06/OPC164_peter/OPC01/index.php?route=product/category&amp;path=67" />
                                             </form>
                                          </div>
                                       </li>
                                       <li class="ttcurrency">
               ...
               <div id="product-category" class="container product-category">
                  ...
                  <div class="row">
                     ...
                     <div id="content" class="col-sm-9">
                        <h1 class="category-name">Carrier Bag</h1>
                                       ...
                                       <ul class="list-unstyled" style="display: block;">
                                          ...
                                          <li class="email col-sm-4">
                                             <div class="data email">
                                                ...
                                                <a href="/cdn-cgi/l/email-protection#c6abafa8af86b2a3abb6aaa7b2a3b2b4afb6e8a5a9ab"><span class="__cf_email__" data-cfemail="3f5b5a52507f58525e5653115c5052">[email&#160;protected]</span></a>
                                                </span>
                                             </div>
                                          </li>
                                       </ul>
