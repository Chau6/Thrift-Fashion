<div class="full-header">
   <div class="header-left">
       <div id="logo">
           <a href="{{route('client.homeindex')}}"><img src="{{asset('images/logo.png')}}" title="Your Store" alt="Your Store" class="img-responsive" style="height: 500px; width: 200px; object-fit: cover;" /></a>
       </div>
   </div>
           ...
           <ul class="list-inline">
               <li class="account-nav dropdown header_user_info">
                   ...
                   <ul class="dropdown-menu dropdown-menu-right account-link-toggle">
                       <li>
                           <a href="{{route('client.register')}}"><i class="material-icons ma-user">perm_identity</i>Register</a>
                       </li>
                       <li>
